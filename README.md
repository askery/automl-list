...
|Auto-Keras            | Python | Open Source | Classification(also for Text)/Regression (also for Text)/Time Series| AutoKeras: An AutoML system based on Keras. The goal of AutoKeras is to make machine learning accessible to everyone<a href="https://github.com/keras-team/autokeras" target="_blank">github</a>
