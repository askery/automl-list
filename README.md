...
|Oboe	               | Python	| BSD-3-Clause| HyperParameter Optimization | Oboe and TensorOboe are automated machine learning (AutoML) systems that use collaborative filtering to find good models for supervised learning tasks within a user-specified time limit | <a href="https://github.com/udellgroup/oboe" target="_blank"> github </a>
