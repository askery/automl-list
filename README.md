...
|Auto-PyTorch          | Python | MIT | Classification/Regression | While early AutoML frameworks focused on optimizing traditional ML pipelines and their hyperparameters, another trend in AutoML is to focus on neural architecture search. To bring the best of these two worlds together | <a href="https://github.com/automl/Auto-PyTorch" target="_blank">github</a>
