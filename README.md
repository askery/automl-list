...
|AutoDL-Projects |Python | MIT | HyperParameter Optimization; Neural Architecture Search	| Automated Deep Learning Projects (AutoDL-Projects) is an open source, lightweight, but useful project for everyone. This project implemented several neural architecture search (NAS) and hyper-parameter optimization (HPO) algorithms.| <a href="https://github.com/D-X-Y/AutoDL-Projects" target="_blank"> github</a>
